"""
nbody: python -u generate_dataset.py  --num-train 50000 --sample-freq 500
nbody_small: python -u generate_dataset.py --num-train 3000 --seed 43 --sufix small
"""
...
suffix = "_charged" + str(args.n_balls) + "_initvel%d" % args.initial_vel + args.sufix
