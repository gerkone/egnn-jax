...
class NBodyDataset:
    ...
    def load(self):
        loc = np.load("nbody/data/loc_" + self.sufix + ".npy")
        vel = np.load("nbody/data/vel_" + self.sufix + ".npy")
        edges = np.load("nbody/data/edges_" + self.sufix + ".npy")
        charges = np.load("nbody/data/charges_" + self.sufix + ".npy")
